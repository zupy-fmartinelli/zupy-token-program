...
use crate::constants::{COMPANY_SEED, LIGHT_COMPRESSED_TOKEN_PROGRAM_ID, LIGHT_TOKEN_CPI_AUTHORITY, TOKEN_2022_PROGRAM_ID};
...
///
/// Data: company_id_u64 (0-7) + amount (8-15) + company_bump (16) + memo (17+)
pub fn process(
    program_id: &Address,
    ...
    // ── CPI: Decompress company compressed balance → pool ATA ────────────
